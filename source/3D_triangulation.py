...
with open(r'C:\ ', "rb") as fp2:   # Unpickling
    p_max_coords_cam2_ = pickle.load(fp2)
with open(r'C:\ ', "rb") as fp3:  # Unpickling
...
for subj in subjects:
    for sess in sessions:
        ...
        print('Session{}_subj{}'.format(subj,sess))
...
writer = pd.ExcelWriter(r'C:\Users\aless\Documents\Universita\MAGISTRALE\Computer vision-Deep learning\DVS_HPE_project\mpjpe_output\mpjpe_3D_conf03_row1_nan.xlsx', engine='xlsxwriter')
